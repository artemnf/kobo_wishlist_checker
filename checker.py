...
chrome_options.add_experimental_option("debuggerAddress", "127.0.0.1:9230")
...
print('Read {page_num} pages and {item_number} items'.format(page_num = page_num, item_number = item_number))
